...
class _SearchScreenState extends State<SearchScreen> {
                ...
                child: BlocBuilder<SearchCubit, SearchState>(
                  builder: (context, state) {
                    if (state is SearchLoading) {
                      ...
                      return _buildInitialData(state);
  ...
  Widget _buildInitialData(SearchInitialDataLoaded state) {
        ...
        children: [
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final imageUrl =
                  category.icons.isNotEmpty ? category.icons.first.url : null;
              return GestureDetector(
                onTap: () => Navigator.pushNamed(
                  context,
                  AppRoutes.categoryTracks,
                  arguments: category,
                ),
                child: Container(
